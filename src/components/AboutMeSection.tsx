        ...
        <div className="sm:col-span-5 sm:col-start-4 w-full">
          <div className="flex flex-col gap-5 sm:gap-10 items-center sm:items-start">
            <p className="leading-[40px] text-xl sm:text-2xl text-center sm:text-left sm:leading-loose">
              ...
              that aren&apos;t just visually compelling but structured with
              intent. I believe great design is more than just aesthetics,
              it&apos;s about clarity, flow, and creating seamless experiences
              that feel effortless for users. I&apos;m on the lookout for
              exciting opportunities, so if you&apos;re interested, get in
              touch!
            </p>
